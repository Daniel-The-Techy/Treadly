        ...
        <h4 class="text-black font-medium text-xl text-center tracking-wide">Choose a category you are interested in</h4>
            <div class="grid grid-cols-2 gap-2 px-4 md:px-6 md:grid-cols-3 mt-12">
                ...
                <div class="flex items-center">
                    ...
                    <label for="nvidia" class="ml-2 text-sm font-medium text-gray-900 ">
                        Nvidia (45)
                    </label>
                </div>
                ...
                <div class="flex items-center">
                    ...
                    <label for="hp" class="ml-2 text-sm font-medium text-gray-900 ">
                        HP (234)
                    </label>
                </div>
                ...
                <div class="flex items-center">
                    ...
                    <label for="benq" class="ml-2 text-sm font-medium text-gray-900 ">
                        BenQ (45)
                    </label>
                </div>
                ...
                <div class="flex items-center">
                    ...
                    <label for="rockstar" class="ml-2 text-sm font-medium text-gray-900 ">
                        Rockstar (49)
                    </label>
                </div>
            </div>
